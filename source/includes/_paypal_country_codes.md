...
You can find all the Country Codes that are supported by Paypal at [this link](https://developer.paypal.com/docs/classic/api/country_codes/) and are also reported here for simplicity.
