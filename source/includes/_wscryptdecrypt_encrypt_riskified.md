...
All Riskified data goes inside the tag `<OrderDetails>`. In this section we will analyze all the fields. 
...
| ----- | -------- | ----------- |
| `SubmitForReview` | 1 |  Flag to activate review over Riskified. <br><ul><li>`0` no submit</li><li>`1` submit</li><ul>
...
| `CommunityScore` | 65  | Aggregate community score for the customer.
...
| `SocialData`     | 20  | The user data from the network.
